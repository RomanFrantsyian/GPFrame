...
pub struct Certificate {
    ...
    /// Σ-ext: tags (`name@version#fingerprint`) of every extension op the
    /// claim was evaluated under. Empty = pure core-Σ claim. Non-empty =
    /// the claim is "equivalent MODULO these plugin semantics" — the
    /// certificate says so forever.
    pub ext_semantics: Vec<String>,
}
