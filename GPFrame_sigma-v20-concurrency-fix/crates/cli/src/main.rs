...
dge — deductive-gp-engine
  dge optimize <path> [--dry-run] [--all] [--jobs <n|auto>] -> whole file/dir: certify+rewrite IN PLACE
  ...
  dge lift     <file.ll|rs> <fn_name>    -> LLVM IR -> Term_p s-expr (v3 P1; gate it!)
  dge trial    <src-dir>                 -> field trial: both doors over a crate, refusals bucketed
